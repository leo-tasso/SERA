"""immigration policy level annual input parameter downloader (World Bank proxy source)."""
...
class ImmigrationPolicyLevelDownloader:
    """Download annual immigration_policy_level proxy for Italy from World Bank."""
        ...
        self.table_mapping: dict[str, Any] = {
            ...
            "source": {
                ...
                "columns": {
                    ...
                    "date": "year",
                    "value": "immigration_policy_level",
                },
            },
            "project": {
                "entity": "policy",
                ...
                "levels": ["national"],
                "notes": "Annual proxy for immigration policy openness through observed net migration.",
            },
        }
    ...
    def save_immigration_policy_level_csv(
        self,
        ...
        print(f"✓ immigration policy level proxy data saved: {output_path}")
